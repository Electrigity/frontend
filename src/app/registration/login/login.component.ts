...
constructor(private _registrationService: RegistrationService, private router: Router) {}
  ...
  async onClickLogin() {
    ...
    // let acc = await this._registrationService.getCurrentUserId();
    //
    // let contract = new web3.eth.Contract(this.contractABI, this.contractAddress);
    // let contract2 = new web3.eth.Contract(
    //   this.contractABI2,
    ...
    // // @ts-ignore
    // const userInfo = await contract2.methods.symbol().call()
    // console.log(userInfo)
    // @ts-ignore
    // const balance: BigInteger = await contract2.methods.balanceOf(acc).call();
    // // @ts-ignore
    // const decimals: BigInteger = await contract2.methods.decimals().call();
    // console.log(Number(balance))
    // console.log(Number(decimals))
    // // @ts-ignore
    // console.log(web3.utils.fromWei(balance, decimals === 18 ? 'ether' : 'mwei'))
    // // @ts-ignore
    // let users: any = await contract.methods.getAllUsersInfo().call()
